...
export default function DotPattern({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("fixed inset-0 overflow-hidden bg-neutral-950 z-[-1] pointer-events-none", className)}
    >
      ...
      {/* Content layer */}
      {children && <div className="relative z-10 h-full w-full pointer-events-none">{children}</div>}
    </div>
  )
}
